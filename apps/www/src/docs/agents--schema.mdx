...
# Schema Agent
Schema agents extend OpenAi functions by providing a small abstraction that allows you to write
a schema for the data that you want to receive from the AI using Zod. Optionally, you can also
provide a description for each field in the schema.
