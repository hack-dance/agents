...
export const AnimatedBorderWrapper = ({
  ...
  return (
    <div
      className={cn(
        `min-w-full group shadow-xl relative overflow-hidden rounded-lg bg-white p-[2px] transition-all duration-300 ease-in-out bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500`,
        {
          "className": !!className,
          "p-[4px]": strokeWidth === 4,
          "p-[3px]": strokeWidth === 3,
